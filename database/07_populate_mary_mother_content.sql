...
VALUES
  ...
  ('About & Contact Page', 'about', 'About and official contacts', 'About & Contact',
   'Learn about the home, the sisters and staff who serve, and the official channels for visits, donations, volunteer coordination, and messages.',
...
VALUES
  ...
  ((SELECT category_id FROM gallery_categories WHERE category_name = 'Home and Facilities'), 'Courtyard View', 'A wider view of the chapel frontage, courtyard, and home exterior.', '/images/mary-mother/about-facility.jpg', 'Wide courtyard view of the chapel frontage and home exterior', 1, 'Published'),
